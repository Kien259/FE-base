...
import TIcon from "@/assets/logo/T-icon";
import TFullIcon from "@/assets/logo/T-full-icon";
      ...
      <div className="flex items-center justify-between gap-2 px-5 pt-5.5 lg:pt-6.5">
        {sidebarOpen ? (
          <NavLink to={PageLink.ROOT}>
            <TFullIcon className="mx-auto w-[96px] h-[28px]" />
          </NavLink>
        ) : (
          <NavLink to={PageLink.ROOT}>
            <TIcon className="mx-auto w-[40px] h-[40px]" />
          </NavLink>
        )}
      </div>
      {/* <!-- SIDEBAR HEADER --> */}
